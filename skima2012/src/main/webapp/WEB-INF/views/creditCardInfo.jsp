...
<div class="row"  style="margin-top: 20px; margin-bottom: 40px;">
	<div class="span12">
		...
		Krungthai Card Public Company, and hereby leaving the SKIMA 2012 registration domain. </p>
		...
		please do not hesitate to contact us at <a href="mailto:skima2012@innova.or.th">skima2012@innova.or.th</a> 
	...
	<div class="span6 offset6" style="text-align: right;">
		...
		<form name="payFormCcard" id="payFormCcard" method="post" action="https://paygate.ktc.co.th/ktc/eng/payment/payForm.jsp">
			...
			<input type="hidden" name="successUrl"	value="http://www.innova.or.th/skima2012/paymentSuccess">
			<input type="hidden" name="failUrl" value="http://www.innova.or.th/skima2012/paymentFail">
			<input type="hidden" name="cancelUrl" value="http://www.innova.or.th/skima2012/paymentCancel">
