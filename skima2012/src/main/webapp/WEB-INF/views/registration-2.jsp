		...
		<div class="controls">
			...
			<label class="radio">
				...
				<span style="color: red;"
        			...
        			data-content="Participants are eligible for student rate if he/she is a full-time undergraduate or postgraduate student. Students must fax in their 'student identification card' to or email the scanned copy to <a href='mailto:skima2012@hotmail.com'>skima2012@hotmail.com</a> or <a href='ouyusong@cdu.edu.cn'>ouyusong@cdu.edu.cu</a>, and to bring along their card to the conference for verification. Only one paper per-registration is allowed under this rate.">
			...
			<label class="radio">
				...
				<span style="color: red;"
        			id="participantInfo"
        			data-original-title="Participant Registration"
        			data-content="Participant to SKIMA 2012 without any paper sumission must be registered with participant registration option">
        			<img style="margin-bottom:10px;" src="<c:url value='/resources/images/info.jpg'/>"/>
        		</span>
			</label>
		</div>
	</div>
	<c:set var="workshopItemErrors"><form:errors path="registrationInfo.workshopItem"/></c:set>
    <c:if test="${not empty workshopItemErrors}">
       	<c:set var="workshopItemCssError">error</c:set>
    </c:if>		 
	<div class="control-group <c:out value='${workshopItemCssError}'/>">
		<label class="control-label"><b>* Workshop (Optional): </b></label>
		<div class="controls">
			<p class="help-block"> <form:errors path="registrationInfo.workshopItem"/></p>
			<label class="radio">
				<form:radiobutton name="workshopOptions" id="workshopOption1" path="registrationInfo.workshopItem" value="notSelected"/>${registrator.registrationInfo.workshopItemNotSelectedWebString}
			</label>
			<label class="radio">
				<form:radiobutton name="workshopOptions" id="workshopOption2" path="registrationInfo.workshopItem" value="oneDay"/>${registrator.registrationInfo.workshopItemOnedayWebString}
			</label>
			<label class="radio">
				<form:radiobutton name="workshopOptions" id="workshopOption3" path="registrationInfo.workshopItem" value="threeDay"/>${registrator.registrationInfo.workshopItemThreedayWebString}
			</label>
		</div>
	</div>	
	...
	<fieldset>
		...
		<div class="control-group <c:out value='${extraCDCssError}'/>">
			...
			<div class="controls">
				...
				@ 50 USD Each <span class="help-inline"><form:errors path="registrationInfo.numExtraCD"/></span>
			</div>
		</div>	
	</fieldset>
<%--	
