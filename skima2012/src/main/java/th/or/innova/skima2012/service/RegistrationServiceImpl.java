package th.or.innova.skima2012.service;
...
import th.or.innova.skima2012.model.Address;
import th.or.innova.skima2012.model.Person;
import th.or.innova.skima2012.model.QPerson;
import th.or.innova.skima2012.model.RegistrationInfo;
import th.or.innova.skima2012.model.RegistrationStatus;
import th.or.innova.skima2012.repository.PersonRepository;
	...
	public void sendRegistrationMail(final Person p) {
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
	         public void prepare(MimeMessage mimeMessage) throws Exception {
	            ...
	            message.setFrom("skima2012@innova.or.th"); // could be parameterized...
	            message.setSubject("SKIMA 2012 Regirstration");
	...
	public void sendReceiptMail(final Person p) {
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
	         public void prepare(MimeMessage mimeMessage) throws Exception {
	        	...
	        	message.setTo(p.getEmail());
	            message.setFrom("skima2012@innova.or.th"); // could be parameterized...
	            message.setSubject("SKIMA 2012 Regirstration Receipt");
	            Map model = new HashMap();
	            model.put("p", p);
	            String text = VelocityEngineUtils.mergeTemplateIntoString(
	            ...
	            message.addAttachment("SKIMA2012_receipt_" + p.getRegistrationInfo().getRefCode() +".pdf", 
